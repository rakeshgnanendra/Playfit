...
class AppointmentApp extends Component<{}, IStateNavbar > {
      
  constructor(props: Readonly<IStateNavbar>, context: any) {
    super(props, context);
  ...
  handleSetAppointmentDate(date: Date) {
    this.setState({ appointmentDate: date, confirmationTextVisible: true });
  }

  handleSetAppointmentSlot(slot: string) {
    this.setState({ appointmentSlot: slot });
  }
  handleSetAppointmentMeridiem(meridiem: any) {
  ...
  checkDisableDate(day: moment.MomentInput) {
  ...
  handleDBReponse(response: any) {
    ...
    //   ? initialSchedule
    //   : appointments.reduce((currentSchedule: { [x: string]: { [x: string]: any; }; },
    //      appointment: { slot_date: any; slot_time: any; }) => {
    ...
    //   slots.length ? slots.every((slot: boolean) => slot === true) ? (schedule[day] = true) : null
    //     : null;
    // }
